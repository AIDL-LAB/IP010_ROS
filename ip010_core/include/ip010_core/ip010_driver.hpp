// _ip010_DRIVER_HPP_
#ifndef _ip010_DRIVER_HPP_
#define _ip010_DRIVER_HPP_
...
#include <ip010_msgs/RobotMotor.h>

#define PI 3.141592
#define WHELL_DIAMETER 0.070
#define WHELL_WITH 0.194
...
namespace aidl
{
	...
	public:
		// constructor
		ip010BodyNode(ros::NodeHandle *nh) : x_(0), y_(0), th_(0), delta_x_(0), delta_y_(0), delta_th_(0), vx_(0), vy_(0), vth_(0),
		...
		{
			// [m/s]
			ip010_msgs::RobotMotor motor_msg;
