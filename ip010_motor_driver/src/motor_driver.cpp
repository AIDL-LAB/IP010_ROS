// motor_driver.cpp
#include <ip010_motor_driver/motor_driver.h>
  ...
  node_up_(false)
{
    ...
    torque_ = false;
    max_rpm_ = 0;
    rpm_pub_ = nh->advertise<ip010_msgs::RobotMotor>("/cur_rpm", 100);
...
void MotorDriver::cmd_rpm_callback(const ip010_msgs::RobotMotor::ConstPtr &msg){
